...
export const trackMeta = {
  ...
  security: {
    ...
    tagline: 'Hands-on cybersecurity: crypto, web, forensics — capture the flag',
    description: '12 CTF-style rooms covering the security fundamentals behind your degree: the CIA triad, encoding, classical and modern crypto, hashing, password cracking, networking, HTTP, SQL injection, the Linux CLI, digital forensics, phishing, and firewalls. Each room ends with a flag you capture in your browser.',
    storageKey: 'security-progress-v1',
    listPath: '/tracks/security',
    detailPath: (id) => `/tracks/security/${id}`,
    language: 'text',
    accentBg: 'bg-rust',
    accentText: 'text-cream',
    accentLight: 'bg-rust/10 text-rust',
    dotColor: 'bg-rust',
    courseCode: 'CYB',
    moduleIndex: [
      { id: 'sec-intro', number: 1, title: 'The Security Mindset' },
      { id: 'sec-encoding', number: 2, title: 'Encoding Is Not Encryption' },
      { id: 'sec-classical-crypto', number: 3, title: 'Classical Ciphers' },
      { id: 'sec-hashing', number: 4, title: 'Hashing & File Integrity' },
      { id: 'sec-passwords', number: 5, title: 'Password Cracking' },
      { id: 'sec-networking', number: 6, title: 'Ports, Protocols & Insecure Services' },
      { id: 'sec-http-headers', number: 7, title: 'HTTP & Reading the Wire' },
      { id: 'sec-web-sqli', number: 8, title: 'SQL Injection' },
      { id: 'sec-linux-cli', number: 9, title: 'The Linux Command Line' },
      { id: 'sec-forensics', number: 10, title: 'Digital Forensics' },
      { id: 'sec-phishing', number: 11, title: 'Social Engineering & Phishing' },
      { id: 'sec-firewall', number: 12, title: 'Firewalls & Defense in Depth' },
    ],
  },
};
