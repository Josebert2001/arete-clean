  ...
  },
  {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ['Something you know, something you have, something you are', 'A password, a PIN and a passphrase', 'Three separate devices approving the same request', 'Three one-time codes sent to three different channels'],
        correctIndex: 0,
        explanation: 'The three factors are independent categories of evidence: something you know (password or PIN), something you have (phone, token or smart card), and something you are (fingerprint, face or iris). Three passwords are not three factors — they are three helpings of the same one. Approval from several devices is dual control, a different and equally real safeguard.',
      },
      {
        ...
        options: ['Dual control (the four-eyes principle)', 'Three-factor authentication', 'Two-factor authentication', 'Graceful degradation'],
        correctIndex: 0,
