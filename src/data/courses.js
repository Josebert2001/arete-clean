export const courses = [
  ...
  },
  {
    ...
    quiz: [
      { question: "The word 'system' originates from the Greek word 'systema'. What does a system most accurately describe?", options: ["A single isolated component", "An orderly grouping of interdependent components linked to achieve a specific goal", "Any piece of computer hardware", "A list of unrelated tasks"], correctIndex: 1, explanation: "A system is an orderly grouping of interdependent components working together toward a specific goal." },
      { question: "In the input-process-output model, which element feeds output information back to adjust the system's functions?", options: ["Processor", "Control", "Feedback", "Boundary"], correctIndex: 2, explanation: "Feedback returns information about the output to the input or control mechanisms so the system can adjust its performance." },
      { question: "Which element of a system transforms input into output?", options: ["Control", "Processor", "Feedback", "Output"], correctIndex: 1, explanation: "The processor is the component that transforms input into output." },
      { question: "What distinguishes an open system from a closed system?", options: ["An open system interacts freely with its environment; a closed system does not", "An open system has no feedback", "A closed system is always larger", "An open system cannot be computerised"], correctIndex: 0, explanation: "An open system interacts freely with external factors in its environment, while a closed system is contained within itself." },
      { question: "System analysis is best described as:", options: ["Writing the final source code", "A problem-solving technique that collects and interprets facts and decomposes a system into sub-systems", "Buying hardware", "Marketing the software"], correctIndex: 1, explanation: "System analysis collects and interprets facts, identifies problems, and decomposes a system into its components or sub-systems." },
      { question: "Which category of information is highly structured and used by lower-level management for day-to-day activities?", options: ["Strategic information", "Managerial information", "Operational information", "Archival information"], correctIndex: 2, explanation: "Operational information is the highly structured day-to-day data used by lower-level management to run daily activities." },
      { question: "What is the primary output of a feasibility study?", options: ["The final software", "A feasibility report recommending to proceed, modify, or abandon", "The source code", "A marketing plan"], correctIndex: 1, explanation: "A feasibility study produces a feasibility report that recommends proceeding with, modifying, or abandoning the project." },
      { question: "A cost-benefit analysis to check whether benefits outweigh costs is which type of feasibility?", options: ["Technical feasibility", "Economic feasibility", "Legal feasibility", "Schedule feasibility"], correctIndex: 1, explanation: "Economic feasibility uses cost-benefit analysis to determine whether the benefits outweigh the costs." },
      { question: "Checking whether a system can be built with existing technology and resources is which feasibility type?", options: ["Operational feasibility", "Technical feasibility", "Legal feasibility", "Economic feasibility"], correctIndex: 1, explanation: "Technical feasibility assesses whether the system can be built and implemented with existing technology and resources." },
      { question: "Ensuring a system complies with applicable laws, regulations, and contractual obligations is:", options: ["Schedule feasibility", "Operational feasibility", "Legal feasibility", "Technical feasibility"], correctIndex: 2, explanation: "Legal feasibility checks compliance with laws, regulations, contracts, and ethical standards." },
      { question: "In problem identification, a 'problem' is defined as:", options: ["Any bug in the code", "A gap between the current state of a system and the desired state", "A hardware failure", "A missing document"], correctIndex: 1, explanation: "A problem is any gap between the current state of a system and the desired state." },
      { question: "What is the difference between symptoms and root causes?", options: ["They are the same thing", "Symptoms are observable effects; root causes are the actual sources of dysfunction", "Root causes are always visible", "Symptoms are the real problem"], correctIndex: 1, explanation: "Symptoms are observable effects of an underlying problem; root causes are the actual sources of the dysfunction." },
      { question: "JAD, a collaborative workshop fact-finding technique, stands for:", options: ["Java Application Design", "Joint Application Development", "Joint Analysis Document", "Just-in-time Agile Delivery"], correctIndex: 1, explanation: "JAD (Joint Application Development) uses collaborative workshops involving users and developers to gather requirements." },
      { question: "What does SDLC stand for?", options: ["System Design Logic Control", "Software Development Life Cycle", "Standard Data Layer Configuration", "Sequential Design and Logic Cycle"], correctIndex: 1, explanation: "SDLC is the Software Development Life Cycle — a structured process to plan, create, test, deploy, and maintain software." },
      { question: "How many phases make up the SDLC as taught in this course?", options: ["Four", "Five", "Seven", "Ten"], correctIndex: 2, explanation: "The seven SDLC phases are Planning, Analysis, Design, Implementation, Testing, Deployment, and Maintenance." },
      { question: "Which question best characterises the SDLC Planning phase?", options: ["How do we code this?", "Should we build this system?", "Who will test it?", "When do we retire it?"], correctIndex: 1, explanation: "The Planning phase asks 'Should we build this system?', covering feasibility, scope, resources, schedule, and risk." },
      { question: "Performance, security, reliability, and usability are examples of which kind of requirement?", options: ["Functional requirements", "Non-functional requirements", "Business requirements only", "Hardware requirements"], correctIndex: 1, explanation: "Non-functional requirements describe how well the system performs — quality attributes like performance, security, and usability." },
      { question: "What is the relationship between SDLC phases and SDLC models?", options: ["They are identical", "Phases are the fundamental activities; models determine how and in what order those phases are executed", "Models replace phases", "Phases only apply to Agile"], correctIndex: 1, explanation: "SDLC phases are the activities any project must do; models (Waterfall, Agile, etc.) decide how and in what order they happen." },
      { question: "The Waterfall Model is best described as:", options: ["A risk-driven spiral", "A linear-sequential approach where each phase finishes before the next begins", "A set of parallel sprints", "A prototype-based loop"], correctIndex: 1, explanation: "Waterfall is a linear-sequential model where each phase is completed and reviewed before the next begins." },
      { question: "In the Waterfall Model, the requirements phase produces which formal document?", options: ["Software Design Document (SDD)", "Software Requirement Specification (SRS)", "Product Backlog", "Sprint Backlog"], correctIndex: 1, explanation: "The requirements analysis phase produces a formal Software Requirement Specification (SRS) that acts as the project blueprint." },
      { question: "Which is a key disadvantage of the Waterfall Model?", options: ["It welcomes change easily", "The customer sees the working product only at the very end, and changes are costly", "It produces no documentation", "It is only for huge projects"], correctIndex: 1, explanation: "Waterfall is inflexible: the customer sees the product only at the end, and late changes or defects are expensive." },
      { question: "When is the Waterfall Model most appropriate?", options: ["When requirements change constantly", "When requirements are stable and the application is small and simple", "For highly experimental research projects", "When the customer must be involved daily"], correctIndex: 1, explanation: "Waterfall suits projects with stable, well-understood requirements and small, simple, stable technology." },
      { question: "Who proposed the Spiral Model, and in what year?", options: ["Barry Boehm, 1986", "Winston Royce, 1970", "Ken Schwaber, 2001", "Edsger Dijkstra, 1968"], correctIndex: 0, explanation: "The Spiral Model was proposed by Barry Boehm in 1986 as a risk-driven, iterative process." },
      { question: "Which quadrant is described as the most critical part of the Spiral Model?", options: ["Objectives Determination and Planning", "Risk Analysis and Resolution", "Development and Testing", "Review and Planning"], correctIndex: 1, explanation: "Risk Analysis and Resolution is the most critical quadrant — risks are identified and mitigated before major investment." },
      { question: "A key disadvantage of the Spiral Model is that it:", options: ["Ignores risk", "Is costly and does not suit smaller, low-risk projects", "Cannot accommodate change", "Produces no working versions"], correctIndex: 1, explanation: "The Spiral Model is complex and costly, requiring risk expertise, and is overkill for small, low-risk projects." },
      { question: "The V-Model is also known as the:", options: ["Verification and Validation Model", "Variable Velocity Model", "Vertical Value Model", "Visual Vector Model"], correctIndex: 0, explanation: "The V-Model is the Verification and Validation Model, pairing each development phase with a corresponding testing phase." },
      { question: "Where does the Coding phase sit in the V-Model?", options: ["At the top-left", "At the bottom of the V, joining the verification and validation branches", "On the right side only", "It has no place in the V-Model"], correctIndex: 1, explanation: "Coding sits at the bottom of the V, connecting the verification (left) and validation (right) branches." },
      { question: "In the V-Model, which testing phase corresponds to (verifies) Module Design?", options: ["Acceptance Testing", "System Testing", "Integration Testing", "Unit Testing"], correctIndex: 3, explanation: "Unit Testing pairs with Module Design — each validation phase verifies its matching design phase." },
      { question: "In the V-Model, Acceptance Testing corresponds to which design/analysis phase?", options: ["Business Requirement Analysis", "Module Design", "Architectural Design", "System Design"], correctIndex: 0, explanation: "Acceptance Testing verifies the Business Requirement Analysis, with user involvement." },
      { question: "A noted limitation of the V-Model is that it:", options: ["Finds defects too late", "Produces no early prototypes, delaying customer feedback, and is inflexible to change", "Has no testing phases", "Cannot be documented"], correctIndex: 1, explanation: "The V-Model is inflexible once development starts and produces no early prototypes, so customer feedback is delayed." },
      { question: "The Incremental Model delivers software by:", options: ["Releasing everything once at the end", "Building and delivering small, functional increments that each add to the previous release", "Only building prototypes", "Skipping testing"], correctIndex: 1, explanation: "In the Incremental Model, requirements are divided into modules and each release adds functionality to the previous one." },
      { question: "Which is an advantage of the Incremental Model?", options: ["No need for module interfaces", "Early delivery of operational software and easier testing of smaller increments", "Requirements never need to be defined", "It guarantees a fixed completion date"], correctIndex: 1, explanation: "The Incremental Model delivers core functions early and makes smaller increments easier to test and debug." },
      { question: "The Evolutionary Process Model is also called the:", options: ["Big Bang model", "Successive version model", "Frozen model", "Single-pass model"], correctIndex: 1, explanation: "The Evolutionary Process Model (successive version model) lets software evolve over time with customer feedback at each stage." },
      { question: "The Prototyping Model primarily helps a team to:", options: ["Avoid the customer", "Build a working model to understand requirements better, then refine it through feedback", "Skip the design phase", "Deliver only documentation"], correctIndex: 1, explanation: "Prototyping builds a working model to clarify requirements, then refines it iteratively based on user feedback." },
      { question: "In throwaway prototyping, the prototype is:", options: ["Refined into the final system", "Built to elicit requirements and then discarded, with the final system built from scratch", "Never shown to the customer", "Used as the production system unchanged"], correctIndex: 1, explanation: "A throwaway prototype is built quickly to elicit requirements, then discarded; the final system is built separately." },
      { question: "In evolutionary prototyping, the prototype is:", options: ["Discarded after one demo", "Progressively refined until it becomes the final system", "Only a paper sketch", "Built by the customer"], correctIndex: 1, explanation: "In evolutionary prototyping the prototype is continuously refined until it becomes the final delivered system." },
      { question: "A common disadvantage of the Prototyping Model is that:", options: ["It detects errors too late", "Users may confuse the prototype with the final system and documentation is often poor", "It needs no client involvement", "It cannot handle changing requirements"], correctIndex: 1, explanation: "Prototyping risks users mistaking the prototype for the final product, and frequent changes lead to poor documentation." },
      { question: "The Agile model is best described as:", options: ["A rigid, documentation-heavy process", "An iterative, incremental approach delivering working software in short 1-4 week iterations", "A single-phase delivery", "A purely sequential model"], correctIndex: 1, explanation: "Agile is iterative and incremental, prioritising flexibility, collaboration, and working software in short iterations." },
      ...
      { question: "How long is a typical Agile iteration (sprint)?", options: ["1 to 4 weeks", "6 to 12 months", "1 to 2 days", "Exactly 1 year"], correctIndex: 0, explanation: "Agile builds software in short iterations of 1 to 4 weeks, delivering a workable product after each." },
      { question: "What is the main role of the Scrum Master?", options: ["To write all the code", "To facilitate Agile practices, remove blocks, and shield the team from disturbances", "To represent the customer's commercial interests", "To approve the project budget"], correctIndex: 1, explanation: "The Scrum Master is a facilitator who helps the team follow Agile practices, removes blockers, and shields the team." },
      { question: "Which responsibility belongs to the Product Owner?", options: ["Removing technical blockers", "Defining and prioritising requirements and representing the voice of the customer", "Running the build server", "Facilitating the daily stand-up"], correctIndex: 1, explanation: "The Product Owner drives the product from a business view — prioritising requirements and representing the customer." },
      ...
      { question: "Which of these is an Agile framework?", options: ["Waterfall", "Scrum", "V-Model", "Spiral"], correctIndex: 1, explanation: "Scrum is an Agile framework (alongside Kanban, Extreme Programming, and SAFe)." },
      { question: "A disadvantage of Agile is that it:", options: ["Cannot handle change", "Makes final cost and timeline hard to predict and needs a highly engaged customer", "Produces too much documentation", "Excludes the customer"], correctIndex: 1, explanation: "Agile's evolving scope makes cost/timeline hard to predict, and it depends on an available, engaged customer/Product Owner." },
      { question: "Which Agile framework is described as the most widely used?", options: ["Kanban", "Extreme Programming", "Scrum", "SAFe"], correctIndex: 2, explanation: "Scrum is the most widely used Agile framework, organising work into sprints with defined roles and artifacts." },
      { question: "In Scrum, the Product Backlog is:", options: ["A subset of tasks for one sprint", "A prioritised list of all features and requirements, owned by the Product Owner", "The final test report", "A list of completed work only"], correctIndex: 1, explanation: "The Product Backlog is the prioritised master list of all features, fixes, and tasks, maintained by the Product Owner." },
      { question: "How does the Sprint Backlog differ from the Product Backlog?", options: ["They are the same", "The Sprint Backlog is a subset the team commits to for one sprint, owned by the development team", "The Sprint Backlog holds every future feature", "The Sprint Backlog is owned by the customer"], correctIndex: 1, explanation: "The Sprint Backlog is the subset of product backlog items the team commits to completing in a given sprint." },
      { question: "What is the purpose of the Daily Scrum (daily stand-up)?", options: ["To demo the finished product", "To keep the team aligned each day during the sprint", "To negotiate the contract", "To replace all other meetings"], correctIndex: 1, explanation: "Daily stand-up meetings (the Daily Scrum) keep the team aligned on progress and obstacles during the sprint." },
      { question: "What is the difference between a Sprint Review and a Sprint Retrospective?", options: ["They are identical", "The Review demonstrates the working increment; the Retrospective reflects on and improves the process", "The Review fixes bugs; the Retrospective writes code", "Only the Retrospective involves the customer"], correctIndex: 1, explanation: "The Sprint Review demos the increment to stakeholders, while the Retrospective reflects on the process to improve it." },
      ...
      { question: "Documentation tends to be heaviest in which model and lightest in which?", options: ["Heaviest in Agile, lightest in Waterfall", "Heaviest in Waterfall, lightest in Agile", "Equal in all models", "Heaviest in Prototyping, lightest in Spiral"], correctIndex: 1, explanation: "Documentation is heaviest in Waterfall (aiding maintenance) and lightest in Agile (favouring speed)." },
      { question: "For fixed-bid contracts or strict regulatory compliance with stable requirements, which approach is often preferable?", options: ["Agile", "Waterfall or Incremental", "Pure prototyping", "No model at all"], correctIndex: 1, explanation: "When cost/schedule predictability matters (fixed-bid or compliance), Waterfall or Incremental are often preferable to Agile." },
    ],
  },
  {
    code: 'CYB 224',
  ...
  },
  {
    ...
    quiz: [
      ...
      { question: "What effect does Grover's Algorithm have on symmetric cryptography such as AES?", options: ["It breaks AES completely", "It roughly halves the effective bit-security level", "It has no effect at all", "It doubles the required key size automatically"], correctIndex: 1, explanation: "Grover's quadratic speed-up turns O(N) search into O(√N), effectively halving the bit-security of a symmetric primitive." },
      { question: "What is the recommended response to Grover's Algorithm for symmetric encryption?", options: ["Abandon AES entirely", "Upgrade AES-128 to AES-256", "Replace AES with RSA", "Switch to ECC"], correctIndex: 1, explanation: "Doubling the key size (AES-128 → AES-256) restores the security margin; no new algorithm is needed for symmetric crypto." },
      { question: "What is the 'Harvest Now, Decrypt Later' (HNDL) attack?", options: ["Encrypting data then deleting the key", "Storing encrypted traffic today to decrypt it once a quantum computer exists", "A phishing campaign against key servers", "A denial-of-service flood on TLS handshakes"], correctIndex: 1, explanation: "Adversaries intercept and archive encrypted data now, intending to decrypt it retroactively after Q-Day — so long-lived data is already at risk." },
      { question: "Mosca's Theorem says an organisation is already at risk when:", options: ["Migration time alone exceeds years until Q-Day", "Data secrecy lifetime alone exceeds years until Q-Day", "Migration time + data secrecy lifetime exceeds years until Q-Day", "It never quantifies risk numerically"], correctIndex: 2, explanation: "If (Migration Time) + (Data Secrecy Lifetime) > (Years until Q-Day), the organisation is already in a state of cryptographic risk." },
      { question: "How many core mathematical families underpin modern post-quantum cryptography?", options: ["Three", "Five", "Seven", "Two"], correctIndex: 1, explanation: "PQC is built across five families: lattice-based, code-based, hash-based, multivariate and isogeny-based — providing structural diversity." },
      { question: "Which mathematical family is the primary basis of the main NIST standards ML-KEM and ML-DSA?", options: ["Code-based", "Hash-based", "Lattice-based", "Isogeny-based"], correctIndex: 2, explanation: "Both ML-KEM and ML-DSA are built on the Module Learning With Errors (M-LWE) lattice problem." },
      { question: "Which PQC candidate was dramatically broken in 2022 on a classical computer in about an hour?", options: ["ML-KEM", "SIKE (isogeny-based)", "SLH-DSA", "HQC"], correctIndex: 1, explanation: "SIKE, the leading isogeny-based candidate, was broken by KU Leuven researchers in 2022 — a key lesson in valuing cryptanalytic scrutiny over elegance." },
      { question: "Which NIST standard specifies ML-KEM?", options: ["FIPS 203", "FIPS 204", "FIPS 205", "FIPS 206"], correctIndex: 0, explanation: "FIPS 203 is the Module-Lattice-Based Key-Encapsulation Mechanism Standard (ML-KEM)." },
      { question: "Which NIST standard specifies ML-DSA?", options: ["FIPS 203", "FIPS 204", "FIPS 205", "FIPS 206"], correctIndex: 1, explanation: "FIPS 204 is the Module-Lattice-Based Digital Signature Standard (ML-DSA), derived from CRYSTALS-Dilithium." },
      { question: "SLH-DSA, the stateless hash-based signature standard, is published as:", options: ["FIPS 203", "FIPS 204", "FIPS 205", "FIPS 206"], correctIndex: 2, explanation: "FIPS 205 is the Stateless Hash-Based Digital Signature Standard (SLH-DSA), derived from SPHINCS+." },
      { question: "What is ML-KEM primarily used for?", options: ["Digital signatures", "Secure key establishment (key encapsulation)", "Hashing passwords", "Random number generation"], correctIndex: 1, explanation: "A Key Encapsulation Mechanism establishes a shared secret over a public network, replacing RSA and Diffie-Hellman key exchange." },
      { question: "ML-KEM was derived from which competition submission?", options: ["CRYSTALS-Kyber", "CRYSTALS-Dilithium", "SPHINCS+", "Falcon"], correctIndex: 0, explanation: "ML-KEM is the standardized form of the CRYSTALS-Kyber KEM." },
      ...
      { question: "What is the main drawback of SLH-DSA?", options: ["Weak security", "Very large signatures and slow signing", "It depends on lattice mathematics", "It has no formal standard"], correctIndex: 1, explanation: "SLH-DSA signatures range from 7,856 to 49,856 bytes, so it suits low-frequency, high-security signing rather than high-throughput use." },
      { question: "HQC, selected by NIST in 2025, derives its security from which problem?", options: ["Learning With Errors", "Syndrome decoding of linear error-correcting codes", "Integer factorization", "Discrete logarithm"], correctIndex: 1, explanation: "HQC is a code-based KEM built on the Syndrome Decoding Problem, independent of lattice mathematics and studied since 1978." },
      { question: "Why does NIST deliberately standardize algorithms from multiple mathematical families?", options: ["To make them faster", "For cryptographic diversity, so one mathematical break does not collapse everything", "For legal patent reasons", "To reduce key sizes"], correctIndex: 1, explanation: "Multi-family diversity means a breakthrough against one foundation (as happened to SIKE) does not eliminate all standardized options." },
      { question: "When is 'Q-Day' — the arrival of a Cryptographically Relevant Quantum Computer — generally estimated?", options: ["It already happened in 2024", "Between 2030 and 2035", "Around 2050", "It will never happen"], correctIndex: 1, explanation: "The consensus estimate for a CRQC capable of breaking RSA-2048 is roughly 2030–2035." },
      { question: "Roughly how many stable logical qubits are estimated to break RSA-2048 with Shor's Algorithm?", options: ["About 96", "About 512", "About 4,096", "About one million"], correctIndex: 2, explanation: "Breaking RSA-2048 needs roughly 4,096 stable logical qubits; as of 2026 the largest machines reach only ~96." },
      { question: "What does dual-mode hybrid cryptography mean during the PQC transition?", options: ["Using two passwords", "Running a classical and a PQC algorithm together so both must be defeated", "Hashing data twice", "Using two certificate authorities"], correctIndex: 1, explanation: "A hybrid combines outputs of a classical algorithm and a PQC algorithm (e.g. X25519 + ML-KEM) so an attacker must break both." },
      { question: "Which hybrid key exchange does Google Chrome deploy by default?", options: ["RSA + AES", "X25519 + ML-KEM-768", "ECDSA + Falcon", "SHA-256 + HQC"], correctIndex: 1, explanation: "Chrome uses an X25519 + ML-KEM-768 hybrid in TLS 1.3 by default, already protecting billions of connections." },
      { question: "Why is DNSSEC a particular challenge for PQC migration?", options: ["Signatures become too small to verify", "PQC signatures exceed UDP packet-size limits, forcing fragmentation and TCP fallback", "DNS cannot be encrypted at all", "DNS is already fully quantum-safe"], correctIndex: 1, explanation: "DNSSEC assumed small signatures; PQC signatures exceed the ~1,232-byte UDP limit, causing fragmentation, dropped packets and TCP fallback." },
      { question: "KyberSlash is an example of what kind of weakness?", options: ["A break of the lattice mathematics itself", "A timing side-channel in certain ML-KEM implementations", "A DNS amplification attack", "A new quantum algorithm"], correctIndex: 1, explanation: "KyberSlash exploited timing variation in a division operation in some ML-KEM implementations — a sound standard can still be implemented insecurely." },
      { question: "Which configuration remains safe even after Grover's Algorithm?", options: ["AES-128", "AES-256", "SHA-256 collision resistance", "RSA-2048"], correctIndex: 1, explanation: "Grover reduces AES-256 to a 128-bit security level, which is still considered safe; AES-128 drops to an unsafe 64-bit level." },
      ...
      { question: "Why don't larger RSA or ECC keys defend against Shor's Algorithm?", options: ["Because Shor is polynomial, so bigger keys add only linear overhead", "Because keys cannot be made larger", "Because Grover assists the attack", "They do fully defend against it"], correctIndex: 0, explanation: "Shor runs in polynomial time, so increasing key size adds only modest linear cost for the attacker — not exponential resistance." },
      { question: "Which countermeasure splits sensitive intermediate values into random shares to resist power analysis?", options: ["Rejection sampling", "Masking", "Fragmentation", "Hybrid mode"], correctIndex: 1, explanation: "Cryptographic masking splits secret values into random shares that individually reveal nothing, defeating side-channel analysis (at ~20–35% overhead)." },
      { question: "What is the first phase of the proposed institutional PQC migration framework?", options: ["Enforce quantum-native algorithms immediately", "Discovery and cryptographic asset inventory", "Buy all-new hardware first", "Do nothing until Q-Day"], correctIndex: 1, explanation: "Phase 1 audits every instance of vulnerable public-key crypto and builds a risk register prioritised by data sensitivity lifetime." },
      { question: "Lattice-based cryptography's security commonly rests on which hard problem?", options: ["Learning With Errors (LWE)", "Syndrome decoding", "Hash collisions", "Integer factorization"], correctIndex: 0, explanation: "Lattice schemes rely on the Learning With Errors problem (and its Module variant), for which no sub-exponential quantum algorithm is known." },
      ...
      { question: "What is the core principle of Zero Trust Architecture?", options: ["Trust but verify", "Never trust, always verify", "Trust all internal users", "Defend only the perimeter"], correctIndex: 1, explanation: "Zero Trust eliminates implicit trust: every user, device and request is authenticated and continuously verified regardless of location." },
      { question: "Who coined the term 'Zero Trust' in 2010?", options: ["John Kindervag at Forrester", "Michele Mosca", "Peter Shor", "Stephen Marsh"], correctIndex: 0, explanation: "John Kindervag coined 'Zero Trust' at Forrester Research in 2010, arguing that trust itself is a vulnerability." },
      { question: "Which Google initiative is the well-known enterprise blueprint for Zero Trust?", options: ["BeyondCorp", "Project Zero", "Operation Aurora", "Titan"], correctIndex: 0, explanation: "Google built and later published BeyondCorp after the Operation Aurora attacks, becoming the model for enterprise Zero Trust." },
      { question: "Which document is the first comprehensive government-endorsed Zero Trust framework?", options: ["NIST SP 800-53", "NIST SP 800-207", "FIPS 203", "ISO 27001"], correctIndex: 1, explanation: "NIST SP 800-207 (2020) defines the Policy Decision Point / Policy Enforcement Point model for Zero Trust." },
      { question: "In Zero Trust, what does the 'assume breach' principle mean?", options: ["Ignore attackers", "Design as if attackers are already inside — encrypt, segment, monitor", "Trust the perimeter firewall", "Disable logging to save resources"], correctIndex: 1, explanation: "Assume breach means building defences on the premise that adversaries already have a foothold, so everything is segmented and monitored." },
      { question: "Micro-segmentation in Zero Trust primarily limits:", options: ["Encryption overhead", "Lateral movement by attackers", "User authentication prompts", "Log volume"], correctIndex: 1, explanation: "Dividing the network into isolated segments contains an intruder and blocks the lateral movement that perimeter models allow." },
      ...
      { question: "Which legacy model does Zero Trust replace?", options: ["The zero-trust model", "The 'castle-and-moat' perimeter model", "Defense in depth", "Least privilege"], correctIndex: 1, explanation: "Zero Trust replaces the castle-and-moat perimeter model, which trusts everything inside the network by default." },
      { question: "What is the goal of least-privilege access?", options: ["Grant the broadest possible access", "Shrink the blast radius of any single compromise", "Eliminate authentication", "Speed up logins"], correctIndex: 1, explanation: "Scoped, time-limited, contextual access ensures a compromised account or device exposes as little as possible." },
      { question: "Why did signature-based detection drive the move to AI/ML in threat detection?", options: ["It caught too many threats", "It only catches previously known attacks, missing zero-day and polymorphic malware", "It was too slow to install", "It used too little data"], correctIndex: 1, explanation: "Signature matching only flags known patterns, so zero-day, polymorphic and behaviour-based attacks slip through." },
      ...
      { question: "Unsupervised learning is most useful in security for:", options: ["Matching known signatures", "Anomaly detection and behaviour analytics on unlabelled data", "Encrypting traffic", "Patching systems"], correctIndex: 1, explanation: "Unsupervised methods (K-Means, PCA, autoencoders) find hidden patterns and anomalies without labels." },
      { question: "What does UEBA stand for in behavioural monitoring?", options: ["User & Entity Behaviour Analytics", "Unified Endpoint Backup Agent", "Universal Encryption Bridging Architecture", "User Event Bus Aggregator"], correctIndex: 0, explanation: "UEBA (User & Entity Behaviour Analytics) baselines normal behaviour and flags deviations as potential threats." },
      { question: "What is the recommended posture for using AI in cybersecurity?", options: ["Full automation that replaces analysts", "Human–AI collaboration with continuous human oversight", "Avoid AI entirely", "Rely only on signatures"], correctIndex: 1, explanation: "AI augments analysts but cannot replace human expertise; responsible use needs oversight, governance and explainability." },
      { question: "A key limitation of AI-based threat detection is:", options: ["It never makes mistakes", "False positives and susceptibility to adversarial attacks", "It needs no training data", "It fully replaces human analysts"], correctIndex: 1, explanation: "Poor training data causes false positives/negatives, and crafted adversarial inputs can mislead models — an ongoing arms race." },
      { question: "What core weakness of point-in-time authentication does behavioral biometrics address?", options: ["Weak passwords only", "The point-of-entry blind spot — no re-verification after login", "Slow login speed", "Lack of encryption"], correctIndex: 1, explanation: "Once login succeeds, legacy systems stop verifying the operator, so a session takeover minutes later goes unnoticed; continuous biometrics removes this blind spot." },
      { question: "Behavioral biometrics validates identity based on:", options: ["What you know (passwords)", "What you possess (tokens)", "How you act dynamically (typing, mouse, touch)", "Your iris pattern only"], correctIndex: 2, explanation: "It is a behavioral, not a knowledge, possession or static-physical factor — it measures the dynamic patterns of how a person interacts." },
      { question: "Which attack floods a user with repeated push prompts until they approve one?", options: ["AitM proxy phishing", "MFA fatigue (prompt bombing)", "Token theft", "Credential stuffing"], correctIndex: 1, explanation: "MFA fatigue spams push notifications until a frustrated or confused user taps approve, handing the attacker access." },
      { question: "How do Adversary-in-the-Middle toolkits like Evilginx defeat static MFA?", options: ["By guessing passwords", "By intercepting and replaying the live session cookie/token in real time", "By brute force", "By denial of service"], correctIndex: 1, explanation: "AitM proxies capture the live MFA token or session cookie and inject it into the attacker's browser, bypassing MFA entirely." },
      { question: "In keystroke dynamics, what is 'dwell time'?", options: ["The interval between two different keys", "The time a single key is held down (press to release)", "The number of typos", "Finger pressure"], correctIndex: 1, explanation: "Dwell (hold) time is key-release minus key-press time for one key, reflecting finger velocity and muscle memory." },
      { question: "'Flight time' in keystroke dynamics measures:", options: ["How long one key is held", "The interval between consecutive keystrokes", "Typing error rate", "Touch pressure"], correctIndex: 1, explanation: "Flight time is the key-to-key interarrival interval — the gap between releasing one key and pressing the next." },
      { question: "How do behavioral systems distinguish humans from bots in cursor movement?", options: ["Bots jitter more than humans", "Humans move in perfect straight lines", "Human paths show natural curvature/tortuosity while bots use mathematically perfect vectors", "They cannot tell them apart"], correctIndex: 2, explanation: "Human muscle movement has physiological noise and corrective micro-adjustments; bots tend to move in perfect vectors or uniform curves." },
      { question: "How many distinct behavioral data dimensions does a comprehensive profile aggregate?", options: ["Three", "Four", "Six", "Ten"], correctIndex: 2, explanation: "The profile combines six dimensions: keystroke dynamics, mouse patterns, touch gestures, device handling, application navigation, and location/context." },
      { question: "Which metric compares live behavior vectors against the stored baseline?", options: ["Hamming distance", "Cosine similarity", "Jaccard index", "MD5 checksum"], correctIndex: 1, explanation: "Cosine similarity measures the cosine of the angle between the live vector and the historical baseline vector to assess match accuracy." },
      { question: "Instead of a binary match/mismatch, the analysis engine outputs:", options: ["A password", "A continuous anomaly score between 0.0 and 1.0", "A simple yes/no", "An encryption key"], correctIndex: 1, explanation: "It produces a probabilistic anomaly score representing how far current behavior deviates from the baseline." },
      { question: "In the response pipeline, an anomaly score of ≥ 0.7 triggers which path?", options: ["Allow (silent pass)", "Challenge (step-up auth)", "Block — terminate the session", "Ignore"], correctIndex: 2, explanation: "A sharp spike (≥0.7) suggests hijacking or bot takeover, so the engine terminates tokens, isolates the device and alerts the SOC." },
      { question: "A mid-range anomaly score (0.3–0.7) typically triggers:", options: ["Silent pass", "A step-up authentication challenge", "Immediate permanent lockout", "Account deletion"], correctIndex: 1, explanation: "Moderate drift prompts a low-friction step-up (push or face scan); if verified, the baseline is safely updated." },
      { question: "Why is the 'desk-walk takeover' mitigated by behavioral biometrics?", options: ["It enforces a longer password", "It detects the new operator's abnormal typing/cursor profile within seconds and locks the terminal", "It disables the mouse", "It only checks at login"], correctIndex: 1, explanation: "Continuous monitoring spots the distinct cadence of an unauthorised operator at an unlocked desk and locks the workstation in seconds." },
      { question: "How do behavioral systems support GDPR/CCPA compliance through data minimization?", options: ["By storing raw keystrokes", "By recording abstract timing deltas and discarding raw key values", "By sharing data with third parties", "By encrypting only passwords"], correctIndex: 1, explanation: "Systems capture timing patterns (e.g. dwell = 42ms) rather than literal characters, avoiding accidental harvesting of passwords or messages." },
      { question: "Which technique maximises resilience by combining several behavioral channels so a drift in one is offset by others?", options: ["Single-factor matching", "Multi-modal biometric fusion", "Password rotation", "Disabling sensors"], correctIndex: 1, explanation: "Multi-modal fusion samples keystroke, mouse, device and context streams together, so a temporary change in one channel does not break authentication." },
    ],
  },
  {
    code: 'UUY-CYB 221',
    ...
    quiz: [
      {
        ...
        options: [
          'Software installed directly on a device that runs without any server',
          'Software controlled by a centralized server and accessed through a browser with an internet connection',
          'A collection of hyperlinks with no underlying code',
          'A hardware firewall that filters web traffic',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Database storage and retrieval on the server',
          'What the page looks like in the user\'s browser (client side)',
      ...
      },
      {
        ...
        options: [
          'Software that only runs inside a web browser',
          'Software installed directly on a user\'s device (iOS or Android)',
          'A server-side script written in ASP.NET',
          'A type of web cookie',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Because every user must install the same app',
          'Because compromising the central server can potentially affect every user',
          'Because mobile devices store all the data',
          'Because the risk only affects one user at a time',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          ...
          'Require a separate version built for each platform (iOS, Android)',
          'Run entirely on the web server',
          'Cannot store any data on the device',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'The centralized web server only',
          'The device and OS features when apps connect to the internet',
          'Printed documentation',
          'The HTML rendering engine of a browser',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Storing sensitive data in plain, unencrypted form on the device',
          'Using HTTPS to send data',
          'Encrypting all tokens before saving them',
          'Refusing to store any data at all',
        ],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          ...
          'Decompiling the app to study its code, find secrets, or modify it to bypass security checks',
          'Updating the app through the official store',
      ...
      },
      {
        ...
        options: [
          ...
          'It removes the manufacturer\'s built-in security restrictions, making it easier for malicious apps to access protected data',
          'It encrypts all app data automatically',
          'It blocks all internet connections',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Requesting far more device permissions than the app actually needs',
          'Refusing all permissions',
          'Asking the user to log in twice',
          'Encrypting the camera feed',
        ],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          'Only offline desktop software',
          'Web-based systems, leading to unauthorized access, data breaches, and service disruption',
      ...
      },
      {
        ...
        options: ['Financial risk', 'Privacy risk', 'Denial of Service', 'Network risk'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Directly on the victim\'s individual device',
          'On the server, distributed across users',
          'Only on paper records',
          'Inside the phone\'s SIM card',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          ...
          'Only the attacker\'s device',
          'Nothing — web apps store no data',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Reverse engineering, code tampering, permission abuse',
          'SQL injection, DDoS, CSRF',
          'Jailbreaking and rooting',
          'Insecure data storage and push spam',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'By flooding the server with traffic from many devices',
          'By injecting malicious code into input fields so the backend database reveals sensitive data',
          'By replacing the homepage with a political message',
          'By tricking a logged-in user into submitting a request',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Injecting harmful scripts into web pages that are then viewed by other users',
          'Overloading a server with traffic',
          'Decompiling a mobile app',
      ...
      },
      {
        ...
        options: [
          'SQL injection targets the database (backend); XSS targets other users\' browsers (frontend)',
          'SQL injection targets browsers; XSS targets the database',
          'They are two names for the same attack',
          'Neither involves injecting code',
        ],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          'The backend is what the user sees; the frontend is the database',
          'The backend is the server-side logic and database the user never sees directly; the frontend is what is rendered in the browser',
          'Both run only on the user\'s phone',
          'The frontend stores all passwords in plain text',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Stealing data quietly from a database',
          'Using a network of compromised devices to flood a site with traffic until it is unavailable',
          'Replacing the homepage with the attacker\'s message',
          'Tricking a user into clicking a phishing link',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'Gaining unauthorized access to hosting files and replacing the homepage with the attacker\'s own message',
          'Encrypting the website for ransom',
          'Sending spam push notifications',
      ...
      },
      {
        ...
        options: ['Deception attacks', 'Injection attacks', 'Availability attacks', 'Permission abuse'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          'Flooding the server with traffic',
          'Tricking a victim into unknowingly submitting a malicious request using their logged-in identity',
      ...
      },
      {
        ...
        options: [
          ...
          'It is universally accessible from any device with an internet connection and a browser',
          'It requires installing a separate version per platform',
      ...
      },
      {
        ...
        options: [
          'Because users must manually reinstall each time',
          'Because developers update directly on the server, making changes instant',
          'Because websites never change',
          'Because each user compiles the code themselves',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'A dynamic website shows the same fixed content to everyone',
          'A dynamic website generates content based on user input, database queries, or other variables',
          'A static website requires a database for every page',
          'A static website changes for each visitor',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          'They cannot be used without an internet connection',
          'They are impossible to update',
          'They never work in a browser',
      ...
      },
      {
        ...
        options: [
          'Regular security audits and regular software updates',
          'Jailbreaking and rooting',
          'Disabling the firewall and removing logs',
      ...
      },
      {
        ...
        options: [
          'Testing methodologies that find vulnerabilities, and protective mechanisms that block attacks in real time',
          'Jailbreaking and rooting',
      ...
      },
      {
        ...
        options: [
          'The app while it is running in production',
          'The app\'s source code during development, before the app is running',
          'Network traffic at the firewall',
      ...
      },
      {
        ...
        options: [
          'Identify known vulnerabilities in third-party libraries and open-source components',
      ...
      },
      {
        ...
        options: [
          'Reading only static source code',
          'Observing app behavior from inside the running application at run time',
          'Scanning printed documentation',
          'Filtering HTTP traffic like a firewall',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: [
          ...
          'While it is running, including servers, typically requiring manual configuration',
          'Only by reading its source code',
          'By decompiling the mobile binary',
        ],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['SAST and DAST', 'WAF and RASP', 'Phishing and spoofing', 'SQLi and XSS'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          'Filtering and monitoring HTTP traffic to block malicious attacks',
      ...
      },
      {
        ...
        options: [
          'Analyzing source code before deployment',
          'Using app instrumentation inside the running application to detect and block attacks',
          'Scanning third-party libraries only',
      ...
      },
      {
        ...
        options: ['Protective mechanisms', 'Testing methodologies', 'Injection attacks', 'Deception attacks'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: [
          'Execute input validation and authorization',
          'Disable all authentication',
          'Store API keys in the frontend',
          'Avoid recording any code changes',
        ],
        correctIndex: 0,
